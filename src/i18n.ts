...
const translations: { [lang: string]: { [key: string]: string } } = {
    ...
    pl: {
        click_to_lock: "Kliknij, aby przechwycić mysz",
        use_esc_key_to_unlock: "Użyj klawisza `Esc`, aby zwolnić",
        use_slider_to_change_sensitivity: "Użyj suwaka po lewej, aby zmienić czułość",
        current_sensitivity: "Aktualna czułość",
        hello: "Cześć",
        hello_guest: "Cześć, gościu!",
        mobile_controls: "Sterowanie mobilne",
        mirrored_controls: "Odwrócone sterowanie",
        scale_controls: "Skala sterowania",
        enter_name_of_drive: "Wprowadź nazwę dysku",
        ws_outdated: "Wymagana aktualizacja przeglądarki DOS",
        update: "Aktualizuj",
        preloading_sockdrive: "Wczytywanie (jednorazowo)",
        filter: "Filtr",
        add: "Dodaj",
        logout: "Wyloguj",
        features: "Funkcje",
        premium: "Subskrypcja",
        buy: "Kup",
        experimental_features: "Dostęp do funkcji eksperymentalnych",
        cloud_saves: "Zapisy w chmurze",
        writeable_fat32: "Dyski FAT32",
        net_no_limits: "Wybór serwera do gry sieciowej",
        unlock_options: "Dostęp do wszystkich ustawień",
        error: "Ups… Coś poszło nie tak…",
        consult_logs: "Sprawdź logi przeglądarki",
        bundle_loading: "Ładowanie pakietu",
        bundle_config: "Odczyt konfiguracji",
        try_free: "dni za darmo",
        upload_file: "Wybierz archiwum jsdos/zip, aby rozpocząć…",
        emulation_backend: "Emulacja",
        render_backend: "Renderowanie",
        render_aspect: "Proporcje obrazu",
        worker: "Wątek w tle",
        mouse_sensitivity: "Czułość myszy",
        mouse_lock: "Przechwycenie myszy",
        volume: "Głośność",
        pause: "Pauza",
        dosboxconf_template: "Szablon dosbox.conf:",
        preview: "Podgląd",
        continue: "Kontynuuj",
        skip: "Pomiń",
        loading: "Ładowanie",
        extract_loading: "Rozpakowywanie archiwum",
        extract_long_time: "Może to potrwać dłużej, proszę czekać…",
        theme: "Motyw",
        create_empty: "Utwórz pusty pakiet",
        uploading_file: "Wysyłanie pliku",
        fs_restart: "Czy chcesz przebudować pakiet, używając tego systemu plików?",
        please_wait: "Proszę czekać",
        making_bundle: "Tworzenie pakietu",
        size: "Rozmiar",
        room: "Pokój",
        server: "Serwer",
        load_by_url: "Wczytaj z linku",
        enter_url: "Wprowadź link",
        load: "Wczytaj",
        stored: "Zapisane",
        delete: "Usuń",
        editor: "Edytor",
        download: "Pobierz",
        changes: "Zapisy",
        loading_saves: "Ładowanie zapisów",
        success: "Sukces",
        success_save: "Zapisano w chmurze",
        warn_save_no_account: "Zapisano w przeglądarce (nie jesteś zalogowany)",
        warn_save_no_premium: "Zapisano w przeglądarce (brak subskrypcji)",
        warn_save_big_file: "Zapisano w przeglądarce (duży plik)",
        unable_to_save: "Błąd zapisu",
        not_premium: "Aktywuj subskrypcję",
        copy_net_link: "Wyślij link do połączenia",
        copied: "Skopiowano",
        image_rendering: "Przetwarzanie obrazu",
        fix: "Napraw",
        close: "Zamknij",
        cancle: "Anuluj",
        manage: "Zarządzaj",
        unable_to_cancle_subscription: "Nie udało się anulować subskrypcji",
        subscription_cancelled: "Subskrypcja anulowana",
        hardware: "Akceleracja sprzętowa",
        play: "Uruchom",
        system_cursor: "Kursor systemowy",
        no_cloud_access: "Aby korzystać z zapisów w chmurze, wprowadź",
        no_cloud_access2: "poniżej",
        no_cloud_access3: "Bez subskrypcji postęp jest zapisywany lokalnie w przeglądarce i może zostać utracony",
        key: "twój klucz",
        load_archive: "Wczytaj archiwum",
        sockdrives: "Gotowe obrazy (sockdrive)",
        confirm_save: "Czy chcesz zapisać postęp?",
        save: "Zapisz",
        emulation_ended: "Emulacja zakończona",
        saving_game: "Zapisywanie gry…",
        sockdrive_save_in_the_middle: "W systemach Win9x bezpieczniej zapisywać po wyłączeniu systemu",
        changes_loaded: "Zapisy wczytane do gry",
        error_deleting_changes: "Błąd usuwania zapisów",
        no_changes_loaded: "Brak zapisów",
        upload: "Wyślij",
        error_uploading_changes: "Błąd wysyłania zapisów",
        delete_changes_confirm: "Czy na pewno chcesz usunąć zapisy?",
        no_changes_to_save: "Brak zmian do zapisania",
        offscreen_canvas: "Renderowanie w tle",
        special_keys: "Klawisze specjalne",
        create_server: "Tworzenie serwera",
        connect_to_network: "Łączenie z siecią",
        lookup_address: "Wyszukiwanie adresu",
        unable_to_connect_to_network: "Nie udało się połączyć z siecią"
    },
};

const initialLang = navigator.language.startsWith("ru") ? "ru" :
    (navigator.language.startsWith("pt") ? "pt" :
        (navigator.language.startsWith("ro") ? "ro" : (navigator.language.startsWith("zhs") ? "zhs" : (navigator.language.startsWith("pl") ? "pl" : "en"))));


const initialState: {
    lang: "ru" | "en" | "pt" | "ro" | "zhs" | "pl",
...
export const i18nSlice = createSlice({
    ...
    initialState,
    reducers: {
        setLang: (state, action: { payload: "ru" | "en" | "pt" | "zhs"| "pl"}) => {
