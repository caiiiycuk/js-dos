...
export default ({children, className: languageClassName, metastring}) => {
    ...
    const fileUrl = codeBlockTitle ? useBaseUrl(codeBlockTitle) : "";
    const [fileSource, setFileSource] = useState(children);
    useEffect(() => {
        if (fileUrl.length > 0) {
            ...
            xhr.onreadystatechange = () => {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    setFileSource(xhr.responseText);
                }
            };
            xhr.send();
        }
              ...
              <>
                ...
                <div className={styles.codeBlockContent}>
                  <a
                    ...
                    style={{ visibility: (fileUrl.length > 0 ? "visible" : "hidden"),
                  ...
                  <button
                    ...
                    style={{ marginRight: (fileUrl.length > 0 ? "50px" : "0") }}
