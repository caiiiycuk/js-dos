...
extern "C" void EMSCRIPTEN_KEEPALIVE client_frame_set_size(int width,
                                                           int height);
extern "C" void EMSCRIPTEN_KEEPALIVE client_frame_update_lines(uint32_t* lines,
                                                               uint32_t count,
                                                               void* rgba);
extern "C" void EMSCRIPTEN_KEEPALIVE client_sound_push(const float* samples,
                                                       int num_samples);
