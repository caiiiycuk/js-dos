...
if (${EMSCRIPTEN})
  ...
  set_target_properties(wworker PROPERTIES LINK_FLAGS "${WORKER_LINK_FLAGS} -s WASM=1 -s ASYNCIFY -s 'ASYNCIFY_IMPORTS=[\"emscripten_sleep\",\"syncSleep\"]' -s ASYNCIFY_WHITELIST=@${CMAKE_CURRENT_LIST_DIR}/../../native/jsdos/asyncify.txt -s EXPORT_NAME='WWORKER'")
endif ()
