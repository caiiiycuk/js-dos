...
static int x86p_ADD_Eb_Gb(void) {
...
static int x86p_ADD_Ew_Gw(void) {
...
static int x86p_ADD_Gb_Eb(void) {
...
static int x86p_ADD_Gw_Ew(void) {
...
static int x86p_ADD_AL_Ib(void) {
...
static int x86p_ADD_AX_Iw(void) {
...
static int x86p_WPUSH_CS(void) {
  CPU_Push16(SegValue(cs));return CASERET_BREAK;
}

static int x86p_2_byte_opcodes(void) {
  core.opcode_index|=0x100;
  return CASERET_RESTART;
  return CASERET_BREAK;
}

static int x86p_ADC_Eb_Gb(void) {
...
static int x86p_ADC_Ew_Gw(void) {
...
static int x86p_ADC_Gb_Eb(void) {
...
static int x86p_ADC_Gw_Ew(void) {
...
static int x86p_ADC_AL_Ib(void) {
...
static int x86p_ADC_AX_Iw(void) {
...
static int x86p_SBB_Ew_Gw(void) {
...
static int x86p_SBB_Gb_Eb(void) {
...
static int x86p_SBB_Gw_Ew(void) {
...
static int x86p_SBB_AL_Ib(void) {
...
static int x86p_SBB_AX_Iw(void) {
...
static int x86p_AND_Ew_Gw(void) {
...
static int x86p_AND_Gb_Eb(void) {
...
static int x86p_AND_Gw_Ew(void) {
...
static int x86p_AND_AL_Ib(void) {
...
static int x86p_AND_AX_Iw(void) {
...
static int x86p_SUB_Eb_Gb(void) {
...
static int x86p_SUB_Ew_Gw(void) {
...
static int x86p_SUB_Gb_Eb(void) {
...
static int x86p_SUB_Gw_Ew(void) {
...
static int x86p_SUB_AL_Ib(void) {
...
static int x86p_SUB_AX_Iw(void) {
...
static int x86p_XOR_Eb_Gb(void) {
...
static int x86p_XOR_Ew_Gw(void) {
...
static int x86p_XOR_Gb_Eb(void) {
...
static int x86p_XOR_Gw_Ew(void) {
...
static int x86p_XOR_AL_Ib(void) {
...
static int x86p_XOR_AX_Iw(void) {
...
static int x86p_CMP_Eb_Gb(void) {
...
static int x86p_CMP_Ew_Gw(void) {
...
static int x86p_CMP_Gb_Eb(void) {
...
static int x86p_CMP_Gw_Ew(void) {
...
static int x86p_CMP_AL_Ib(void) {
...
static int x86p_CMP_AX_Iw(void) {
...
static int x86p_ARPL_Ew_Rw(void) {
  {
...
static int x86p_WPUSH_Ib(void) {
  CPU_Push16(Fetchbs());
  return CASERET_BREAK;
}

static int x86p_IMUL_Gw_Ew_Ib(void) {
...
static int x86p_OUTSB(void) {
  if (CPU_IO_Exception(cpu_regs.regs[REGI_DX].word[0],1)) { CPU_Exception(cpu.exception.which,cpu.exception.error); return CASERET_CONTINUE; };
  DoString(R_OUTSB);return CASERET_BREAK;
}

static int x86p_OUTSW(void) {
  if (CPU_IO_Exception(cpu_regs.regs[REGI_DX].word[0],2)) { CPU_Exception(cpu.exception.which,cpu.exception.error); return CASERET_CONTINUE; };
  DoString(R_OUTSW);return CASERET_BREAK;
}

static int x86p_WJO(void) {
...
static int x86p_WJNO(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_OF())) cpu_regs.ip.word[0]+=Fetchbs(); cpu_regs.ip.word[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_WJB(void) {
...
static int x86p_WJNB(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_CF())) cpu_regs.ip.word[0]+=Fetchbs(); cpu_regs.ip.word[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_WJZ(void) {
...
static int x86p_WJNZ(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_ZF())) cpu_regs.ip.word[0]+=Fetchbs(); cpu_regs.ip.word[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_WJBE(void) {
...
static int x86p_WJNBE(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_CF() && !get_ZF())) cpu_regs.ip.word[0]+=Fetchbs(); cpu_regs.ip.word[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_WJS(void) {
...
static int x86p_WJNS(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_SF())) cpu_regs.ip.word[0]+=Fetchbs(); cpu_regs.ip.word[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_WJP(void) {
...
static int x86p_WJNP(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_PF())) cpu_regs.ip.word[0]+=Fetchbs(); cpu_regs.ip.word[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_WJL(void) {
...
static int x86p_WJNL(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if (((get_SF()!=0) == (get_OF()!=0))) cpu_regs.ip.word[0]+=Fetchbs(); cpu_regs.ip.word[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_WJLE(void) {
...
static int x86p_WJNLE(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_ZF() && ((get_SF()!=0) == (get_OF()!=0)))) cpu_regs.ip.word[0]+=Fetchbs(); cpu_regs.ip.word[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_Grpl_Eb_Ib(void) {
  {
...
static int x86p_Grpl_Ew_Iw(void) {
  {
   Bit8u rm=Fetchb();;Bitu which=(rm>>3)&7;
   if (rm>= 0xc0) {
...
static int x86p_Grpl_Ew_Ix(void) {
  {
   Bit8u rm=Fetchb();;Bitu which=(rm>>3)&7;
   if (rm>= 0xc0) {
...
static int x86p_TEST_Eb_Gb(void) {
...
static int x86p_TEST_Ew_Gw(void) {
...
static int x86p_XCHG_Eb_Gb(void) {
  {
...
static int x86p_XCHG_Ew_Gw(void) {
  {
...
static int x86p_MOV_Eb_Gb(void) {
  {
...
static int x86p_MOV_Ew_Gw(void) {
  {
   Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;
...
static int x86p_MOV_Gb_Eb(void) {
  {
   Bit8u rm=Fetchb();; Bit8u * rmrb; rmrb=lookupRMregb[rm];;;
...
static int x86p_MOV_Gw_Ew(void) {
  {
   Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;
...
static int x86p_WMov_Ew_Sw(void) {
  {
...
static int x86p_MOV_Sw_Ew(void) {
  {
   Bit8u rm=Fetchb();;Bit16u val;Bitu which=(rm>>3)&7;
...
static int x86p_NOP(void) {
  return CASERET_BREAK;
}

static int x86p_XCHG_CX_AX(void) {
...
static int x86p_XCHG_DX_AX(void) {
...
static int x86p_XCHG_BX_AX(void) {
...
static int x86p_XCHG_SP_AX(void) {
...
static int x86p_XCHG_BP_AX(void) {
...
static int x86p_XCHG_SI_AX(void) {
...
static int x86p_XCHG_DI_AX(void) {
...
static int x86p_LAHF(void) {
  FillFlags();
  cpu_regs.regs[REGI_AX].byte[1]=cpu_regs.flags&0xff;
  return CASERET_BREAK;
}

static int x86p_MOV_AL_Ob(void) {
  {
...
static int x86p_MOV_AX_Ow(void) {
  {
   PhysPt eaa; if ((core.prefixes & 0x1)) { eaa=core.base_ds+Fetchd(); } else { eaa=core.base_ds+Fetchw(); };
...
static int x86p_MOV_Ob_AL(void) {
  {
   PhysPt eaa; if ((core.prefixes & 0x1)) { eaa=core.base_ds+Fetchd(); } else { eaa=core.base_ds+Fetchw(); };
...
static int x86p_MOV_Ow_AX(void) {
  {
   PhysPt eaa; if ((core.prefixes & 0x1)) { eaa=core.base_ds+Fetchd(); } else { eaa=core.base_ds+Fetchw(); };
...
static int x86p_TEST_AX_Iw(void) {
...
static int x86p_GRP2_Ew_Ib(void) {
...
static int x86p_WRETN_Iw(void) {
  cpu_regs.ip.dword[0]=CPU_Pop16();
  cpu_regs.regs[REGI_SP].dword[0]+=Fetchw();
  return CASERET_CONTINUE;
}

static int x86p_WRETN(void) {
  cpu_regs.ip.dword[0]=CPU_Pop16();
  return CASERET_CONTINUE;
}

static int x86p_WLES(void) {
  {
   Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;
...
static int x86p_MOV_Eb_Ib(void) {
  {
   Bit8u rm=Fetchb();;
...
static int x86p_MOV_EW_Iw(void) {
  {
   Bit8u rm=Fetchb();;
...
static int x86p_WENTER_Iw_Ib(void) {
  {
   Bitu bytes=Fetchw();
   Bitu level=Fetchb();
...
static int x86p_WRETF(void) {
  FillFlags();
  CPU_RET(false,0,(core.cseip-SegPhys(cs)));
  return CASERET_CONTINUE;
}

static int x86p_INT3(void) {
...
static int x86p_GRP2_Eb_1(void) {
...
static int x86p_GRP2_Ew_1(void) {
...
static int x86p_GRP2_Eb_CL(void) {
...
static int x86p_GRP2_Ew_CL(void) {
...
static int x86p_SALC(void) {
  cpu_regs.regs[REGI_AX].byte[0] = get_CF() ? 0xFF : 0;
  return CASERET_BREAK;
}

static int x86p_XLAT(void) {
  if ((core.prefixes & 0x1)) {
...
static int x86p_OUT_Ib_AL(void) {
  {
   Bitu port=Fetchb();
   if (CPU_IO_Exception(port,1)) { CPU_Exception(cpu.exception.which,cpu.exception.error); return CASERET_CONTINUE; };
...
static int x86p_OUT_Ib_AX(void) {
  {
   Bitu port=Fetchb();
   if (CPU_IO_Exception(port,2)) { CPU_Exception(cpu.exception.which,cpu.exception.error); return CASERET_CONTINUE; };
...
static int x86p_GRP3_Ew_Iw(void) {
  {
   Bit8u rm=Fetchb();;Bitu which=(rm>>3)&7;
   switch (which) {
   case 0x00:
...
static int x86p_0F_WGRP_6_Exxx(void) {
  {
   if ((cpu_regs.flags & 0x00020000) || (!cpu.pmode)) return CASERET_ILLEGAL;
   Bit8u rm=Fetchb();;Bitu which=(rm>>3)&7;
   switch (which) {
...
static int x86p_Group_7_Ew(void) {
  {
   Bit8u rm=Fetchb();;Bitu which=(rm>>3)&7;
   if (rm < 0xc0) {
...
static int x86p_LAR_Gw_Ew(void) {
  {
   if ((cpu_regs.flags & 0x00020000) || (!cpu.pmode)) return CASERET_ILLEGAL;
...
static int x86p_LSL_Gw_Ew(void) {
  {
   if ((cpu_regs.flags & 0x00020000) || (!cpu.pmode)) return CASERET_ILLEGAL;
...
static int x86p_CLTS(void) {
  if (cpu.pmode && cpu.cpl) { CPU_Exception(13); return CASERET_CONTINUE; };
  cpu.cr0&=(~0x00000008);
  return CASERET_BREAK;
}

static int x86p_INVD(void) {
  if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
  if (cpu.pmode && cpu.cpl) { CPU_Exception(13); return CASERET_CONTINUE; };
  return CASERET_BREAK;
}

static int x86p_MOV_Rd_CRx(void) {
  {
   Bit8u rm=Fetchb();;
   Bitu which=(rm >> 3) & 7;
   if (rm < 0xc0 ) {
...
static int x86p_MOV_Rd_DRx(void) {
  {
   Bit8u rm=Fetchb();;
   Bitu which=(rm >> 3) & 7;
   if (rm < 0xc0 ) {
...
static int x86p_MOV_CRx_Rd(void) {
  {
   Bit8u rm=Fetchb();;
   Bitu which=(rm >> 3) & 7;
   if (rm < 0xc0 ) {
...
static int x86p_MOV_DRx_Rd(void) {
  {
   Bit8u rm=Fetchb();;
   Bitu which=(rm >> 3) & 7;
   if (rm < 0xc0 ) {
...
static int x86p_MOV_Rd_TRx(void) {
  {
   Bit8u rm=Fetchb();;
   Bitu which=(rm >> 3) & 7;
   if (rm < 0xc0 ) {
...
static int x86p_MOV_TRx_Rd(void) {
  {
   Bit8u rm=Fetchb();;
   Bitu which=(rm >> 3) & 7;
   if (rm < 0xc0 ) {
...
static int x86p_0F_WJNO(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_OF())) cpu_regs.ip.word[0]+=Fetchws(); cpu_regs.ip.word[0]+=2; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_WJB(void) {
...
static int x86p_0F_WJNB(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_CF())) cpu_regs.ip.word[0]+=Fetchws(); cpu_regs.ip.word[0]+=2; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_WJZ(void) {
...
static int x86p_0F_WJNZ(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_ZF())) cpu_regs.ip.word[0]+=Fetchws(); cpu_regs.ip.word[0]+=2; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_WJBE(void) {
...
static int x86p_0F_WJNBE(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_CF() && !get_ZF())) cpu_regs.ip.word[0]+=Fetchws(); cpu_regs.ip.word[0]+=2; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_WJS(void) {
...
static int x86p_0F_WJNS(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_SF())) cpu_regs.ip.word[0]+=Fetchws(); cpu_regs.ip.word[0]+=2; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_WJP(void) {
...
static int x86p_0F_WJNP(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_PF())) cpu_regs.ip.word[0]+=Fetchws(); cpu_regs.ip.word[0]+=2; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_WJL(void) {
...
static int x86p_0F_WJNL(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if (((get_SF()!=0) == (get_OF()!=0))) cpu_regs.ip.word[0]+=Fetchws(); cpu_regs.ip.word[0]+=2; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_WJLE(void) {
...
static int x86p_0F_WJNLE(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_ZF() && ((get_SF()!=0) == (get_OF()!=0)))) cpu_regs.ip.word[0]+=Fetchws(); cpu_regs.ip.word[0]+=2; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_SETO(void) {
...
static int x86p_SETNO(void) {
  { Bit8u rm=Fetchb();; if (rm >= 0xc0 ) {Bit8u * earb=lookupRMEAregb[rm];;*earb=((!get_OF())) ? 1 : 0;} else {PhysPt eaa=(core.ea_table)[rm]();;mem_writeb(eaa,((!get_OF())) ? 1 : 0);} };return CASERET_BREAK;
}

static int x86p_SETB(void) {
...
static int x86p_SETNB(void) {
  { Bit8u rm=Fetchb();; if (rm >= 0xc0 ) {Bit8u * earb=lookupRMEAregb[rm];;*earb=((!get_CF())) ? 1 : 0;} else {PhysPt eaa=(core.ea_table)[rm]();;mem_writeb(eaa,((!get_CF())) ? 1 : 0);} };return CASERET_BREAK;
}

static int x86p_SETZ(void) {
...
static int x86p_SETNZ(void) {
  { Bit8u rm=Fetchb();; if (rm >= 0xc0 ) {Bit8u * earb=lookupRMEAregb[rm];;*earb=((!get_ZF())) ? 1 : 0;} else {PhysPt eaa=(core.ea_table)[rm]();;mem_writeb(eaa,((!get_ZF())) ? 1 : 0);} }; return CASERET_BREAK;
}

static int x86p_SETBE(void) {
...
static int x86p_SETNBE(void) {
  { Bit8u rm=Fetchb();; if (rm >= 0xc0 ) {Bit8u * earb=lookupRMEAregb[rm];;*earb=((!get_CF() && !get_ZF())) ? 1 : 0;} else {PhysPt eaa=(core.ea_table)[rm]();;mem_writeb(eaa,((!get_CF() && !get_ZF())) ? 1 : 0);} };return CASERET_BREAK;
}

static int x86p_SETS(void) {
...
static int x86p_SETNS(void) {
  { Bit8u rm=Fetchb();; if (rm >= 0xc0 ) {Bit8u * earb=lookupRMEAregb[rm];;*earb=((!get_SF())) ? 1 : 0;} else {PhysPt eaa=(core.ea_table)[rm]();;mem_writeb(eaa,((!get_SF())) ? 1 : 0);} };return CASERET_BREAK;
}

static int x86p_SETP(void) {
...
static int x86p_SETNP(void) {
  { Bit8u rm=Fetchb();; if (rm >= 0xc0 ) {Bit8u * earb=lookupRMEAregb[rm];;*earb=((!get_PF())) ? 1 : 0;} else {PhysPt eaa=(core.ea_table)[rm]();;mem_writeb(eaa,((!get_PF())) ? 1 : 0);} };return CASERET_BREAK;
}

static int x86p_SETL(void) {
...
static int x86p_SETNL(void) {
  { Bit8u rm=Fetchb();; if (rm >= 0xc0 ) {Bit8u * earb=lookupRMEAregb[rm];;*earb=(((get_SF()!=0) == (get_OF()!=0))) ? 1 : 0;} else {PhysPt eaa=(core.ea_table)[rm]();;mem_writeb(eaa,(((get_SF()!=0) == (get_OF()!=0))) ? 1 : 0);} };return CASERET_BREAK;
}

static int x86p_SETLE(void) {
...
static int x86p_SHLD_Ew_Gw_Ib(void) {
...
static int x86p_SHLD_Ew_Gw_CL(void) {
...
static int x86p_SHRD_Ew_Gw_Ib(void) {
...
static int x86p_SHRD_Ew_Gw_CL(void) {
...
static int x86p_IMUL_Gw_Ew(void) {
...
static int x86p_cmpxchg_Eb_Gb(void) {
  {
   if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
   FillFlags();
   Bit8u rm=Fetchb();; Bit8u * rmrb; rmrb=lookupRMregb[rm];;;
...
static int x86p_cmpxchg_Ew_Gw(void) {
  {
   if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
   FillFlags();
   Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;
...
static int x86p_BTR_Ew_Gw(void) {
  {
   FillFlags();Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;
   Bit16u mask=1 << (*rmrw & 15);
   if (rm >= 0xc0 ) {
...
static int x86p_MOVZX_Gw_Eb(void) {
  {
   Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;
...
static int x86p_GRP8_Ew_Ib(void) {
  {
...
static int x86p_BTC_Ew_Gw(void) {
  {
   FillFlags();Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;
   Bit16u mask=1 << (*rmrw & 15);
   if (rm >= 0xc0 ) {
...
static int x86p_BSF_Gw_Ew(void) {
  {
   Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;
   Bit16u result,value;
...
static int x86p_BSR_Gw_Ew(void) {
  {
   Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;
   Bit16u result,value;
   if (rm >= 0xc0) { Bit16u * earw=lookupRMEAregw[rm];; value=*earw; }
...
static int x86p_MOVSX_Gw_Eb(void) {
  {
   Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;
...
static int x86p_XADD_Gb_Eb(void) {
  {
   if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
   Bit8u rm=Fetchb();; Bit8u * rmrb; rmrb=lookupRMregb[rm];;;Bit8u oldrmrb=*rmrb;
   if (rm >= 0xc0 ) {Bit8u * earb=lookupRMEAregb[rm];;*rmrb=*earb;*earb+=oldrmrb;}
...
static int x86p_XADD_Gw_Ew(void) {
  {
   if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
   Bit8u rm=Fetchb();; Bit16u * rmrw; rmrw=lookupRMregw[rm];;;Bit16u oldrmrw=*rmrw;
   if (rm >= 0xc0 ) {Bit16u * earw=lookupRMEAregw[rm];;*rmrw=*earw;*earw+=oldrmrw;}
...
static int x86p_ADD_Gd_Ed(void) {
...
static int x86p_ADD_EAX_Id(void) {
...
static int x86p_OR_EAX_Id(void) {
...
static int x86p_DPUSH_CS(void) {
  CPU_Push32(SegValue(cs));return CASERET_BREAK;
}

static int x86p_ADC_Ed_Gd(void) {
...
static int x86p_ADC_Gd_Ed(void) {
...
static int x86p_ADC_EAX_Id(void) {
...
static int x86p_SBB_Gd_Ed(void) {
...
static int x86p_SBB_EAX_Id(void) {
...
static int x86p_AND_Gd_Ed(void) {
...
static int x86p_AND_EAX_Id(void) {
...
static int x86p_SUB_Ed_Gd(void) {
...
static int x86p_SUB_Gd_Ed(void) {
...
static int x86p_SUB_EAX_Id(void) {
...
static int x86p_XOR_Ed_Gd(void) {
...
static int x86p_XOR_Gd_Ed(void) {
...
static int x86p_XOR_EAX_Id(void) {
...
static int x86p_CMP_Ed_Gd(void) {
...
static int x86p_CMP_Gd_Ed(void) {
...
static int x86p_CMP_EAX_Id(void) {
...
static int x86p_ARPL_Ed_Rd(void) {
  {
...
static int x86p_PUSH_Id(void) {
  CPU_Push32(Fetchd());return CASERET_BREAK;
}

static int x86p_IMUL_Gd_Ed_Id(void) {
...
static int x86p_DPUSH_Ib(void) {
  CPU_Push32(Fetchbs());return CASERET_BREAK;
}

static int x86p_IMUL_Gd_Ed_Ib(void) {
...
static int x86p_OUTSD(void) {
  if (CPU_IO_Exception(cpu_regs.regs[REGI_DX].word[0],4)) { CPU_Exception(cpu.exception.which,cpu.exception.error); return CASERET_CONTINUE; };
  DoString(R_OUTSD);return CASERET_BREAK;
}

static int x86p_DJO(void) {
...
static int x86p_DJNO(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_OF())) cpu_regs.ip.dword[0]+=Fetchbs(); cpu_regs.ip.dword[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_DJB(void) {
...
static int x86p_DJNB(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_CF())) cpu_regs.ip.dword[0]+=Fetchbs(); cpu_regs.ip.dword[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_DJZ(void) {
...
static int x86p_DJNZ(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_ZF())) cpu_regs.ip.dword[0]+=Fetchbs(); cpu_regs.ip.dword[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_DJBE(void) {
...
static int x86p_DJNBE(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_CF() && !get_ZF())) cpu_regs.ip.dword[0]+=Fetchbs(); cpu_regs.ip.dword[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_DJS(void) {
...
static int x86p_DJNS(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_SF())) cpu_regs.ip.dword[0]+=Fetchbs(); cpu_regs.ip.dword[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_DJP(void) {
...
static int x86p_DJNP(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_PF())) cpu_regs.ip.dword[0]+=Fetchbs(); cpu_regs.ip.dword[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_DJL(void) {
...
static int x86p_DJNL(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if (((get_SF()!=0) == (get_OF()!=0))) cpu_regs.ip.dword[0]+=Fetchbs(); cpu_regs.ip.dword[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_DJLE(void) {
...
static int x86p_DJNLE(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_ZF() && ((get_SF()!=0) == (get_OF()!=0)))) cpu_regs.ip.dword[0]+=Fetchbs(); cpu_regs.ip.dword[0]+=1; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_Grpl_Ed_Id(void) {
  {
   Bit8u rm=Fetchb();;Bitu which=(rm>>3)&7;
   if (rm >= 0xc0) {
...
static int x86p_Grpl_Ed_Ix(void) {
  {
   Bit8u rm=Fetchb();;Bitu which=(rm>>3)&7;
   if (rm >= 0xc0) {
...
static int x86p_TEST_Ed_Gd(void) {
...
static int x86p_XCHG_Ed_Gd(void) {
  {
...
static int x86p_MOV_Ed_Gd(void) {
  {
...
static int x86p_MOV_Gd_Ed(void) {
  {
   Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;
...
static int x86p_DMov_Ew_Sw(void) {
   {
    Bit8u rm=Fetchb();;Bit16u val;Bitu which=(rm>>3)&7;
    switch (which) {
    case 0x00:
...
static int x86p_XCHG_ECX_EAX(void) {
...
static int x86p_XCHG_EDX_EAX(void) {
...
static int x86p_XCHG_EBX_EAX(void) {
...
static int x86p_XCHG_ESP_EAX(void) {
...
static int x86p_XCHG_EBP_EAX(void) {
...
static int x86p_XCHG_ESI_EAX(void) {
...
static int x86p_XCHG_EDI_EAX(void) {
...
static int x86p_MOV_EAX_Od(void) {
  {
   PhysPt eaa; if ((core.prefixes & 0x1)) { eaa=core.base_ds+Fetchd(); } else { eaa=core.base_ds+Fetchw(); };
...
static int x86p_MOV_Od_EAX(void) {
  {
   PhysPt eaa; if ((core.prefixes & 0x1)) { eaa=core.base_ds+Fetchd(); } else { eaa=core.base_ds+Fetchw(); };
...
static int x86p_MOVSD(void) {
  DoString(R_MOVSD);return CASERET_BREAK;
}

static int x86p_CMPSD(void) {
  DoString(R_CMPSD);return CASERET_BREAK;
}

static int x86p_TEST_EAX_Id(void) {
...
static int x86p_DRETN_Iw(void) {
  cpu_regs.ip.dword[0]=CPU_Pop32();
  cpu_regs.regs[REGI_SP].dword[0]+=Fetchw();
  return CASERET_CONTINUE;
}

static int x86p_DRETN(void) {
  cpu_regs.ip.dword[0]=CPU_Pop32();
  return CASERET_CONTINUE;
}

static int x86p_DLES(void) {
  {
   Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;
   if (rm >= 0xc0) return CASERET_ILLEGAL;
   PhysPt eaa=(core.ea_table)[rm]();;
...
static int x86p_MOV_Ed_Id(void) {
  {
   Bit8u rm=Fetchb();;
...
static int x86p_DENTER_Iw_Ib(void) {
  {
   Bitu bytes=Fetchw();
   Bitu level=Fetchb();
...
static int x86p_GRP2_Ed_1(void) {
...
static int x86p_GRP2_Ed_CL(void) {
...
static int x86p_IN_EAX_Ib(void) {
  {
   Bitu port=Fetchb();
...
static int x86p_OUT_Ib_EAX(void) {
  {
   Bitu port=Fetchb();
   if (CPU_IO_Exception(port,4)) { CPU_Exception(cpu.exception.which,cpu.exception.error); return CASERET_CONTINUE; };
...
static int x86p_0F_DGRP_6_Exxx(void) {
  {
   if ((cpu_regs.flags & 0x00020000) || (!cpu.pmode)) return CASERET_ILLEGAL;
   Bit8u rm=Fetchb();;Bitu which=(rm>>3)&7;
   switch (which) {
...
static int x86p_Group_7_Ed(void) {
  {
   Bit8u rm=Fetchb();;Bitu which=(rm>>3)&7;
   if (rm < 0xc0) {
    PhysPt eaa=(core.ea_table)[rm]();;Bitu limit;
...
static int x86p_LAR_Gd_Ed(void) {
  {
   if ((cpu_regs.flags & 0x00020000) || (!cpu.pmode)) return CASERET_ILLEGAL;
...
static int x86p_LSL_Gd_Ew(void) {
  {
   if ((cpu_regs.flags & 0x00020000) || (!cpu.pmode)) return CASERET_ILLEGAL;
...
static int x86p_0F_DJNO(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_OF())) cpu_regs.ip.dword[0]+=Fetchds(); cpu_regs.ip.dword[0]+=4; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_DJB(void) {
...
static int x86p_0F_DJNB(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_CF())) cpu_regs.ip.dword[0]+=Fetchds(); cpu_regs.ip.dword[0]+=4; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_DJZ(void) {
...
static int x86p_0F_DJNZ(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_ZF())) cpu_regs.ip.dword[0]+=Fetchds(); cpu_regs.ip.dword[0]+=4; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_DJBE(void) {
...
static int x86p_0F_DJNBE(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_CF() && !get_ZF())) cpu_regs.ip.dword[0]+=Fetchds(); cpu_regs.ip.dword[0]+=4; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_DJS(void) {
...
static int x86p_0F_DJNS(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_SF())) cpu_regs.ip.dword[0]+=Fetchds(); cpu_regs.ip.dword[0]+=4; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_DJP(void) {
...
static int x86p_0F_DJNP(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if ((!get_PF())) cpu_regs.ip.dword[0]+=Fetchds(); cpu_regs.ip.dword[0]+=4; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_DJL(void) {
...
static int x86p_0F_DJNL(void) {
  { cpu_regs.ip.dword[0]=(core.cseip-SegPhys(cs));; if (((get_SF()!=0) == (get_OF()!=0))) cpu_regs.ip.dword[0]+=Fetchds(); cpu_regs.ip.dword[0]+=4; return CASERET_CONTINUE; };return CASERET_BREAK;
}

static int x86p_0F_DJLE(void) {
...
static int x86p_SHLD_Ed_Gd_Ib(void) {
...
static int x86p_SHLD_Ed_Gd_CL(void) {
...
static int x86p_SHRD_Ed_Gd_Ib(void) {
...
static int x86p_SHRD_Ed_Gd_CL(void) {
...
static int x86p_IMUL_Gd_Ed(void) {
  {
...
static int x86p_CMPXCHG_Ed_Gd(void) {
  {
...
static int x86p_BTR_Ed_Gd(void) {
  {
   FillFlags();Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;
   Bit32u mask=1 << (*rmrd & 31);
   if (rm >= 0xc0 ) {
...
static int x86p_MOVZX_Gd_Eb(void) {
  {
   Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;
...
static int x86p_MOVXZ_Gd_Ew(void) {
  {
   Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;
...
static int x86p_GRP8_Ed_Ib(void) {
  {
   FillFlags();Bit8u rm=Fetchb();;
   if (rm >= 0xc0 ) {
    Bit32u * eard=lookupRMEAregd[rm];;
...
static int x86p_BTC_Ed_Gd(void) {
  {
   FillFlags();Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;
   Bit32u mask=1 << (*rmrd & 31);
   if (rm >= 0xc0 ) {
...
static int x86p_BSF_Gd_Ed(void) {
  {
   Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;
   Bit32u result,value;
...
static int x86p_BSR_Gd_Ed(void) {
  {
   Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;
   Bit32u result,value;
   if (rm >= 0xc0) { Bit32u * eard=lookupRMEAregd[rm];; value=*eard; }
...
static int x86p_MOVSX_Gd_Eb(void) {
  {
   Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;
...
static int x86p_MOVSX_Gd_Ew(void) {
  {
   Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;
...
static int x86p_XADD_Gd_Ed(void) {
  {
   if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
   Bit8u rm=Fetchb();; Bit32u * rmrd; rmrd=lookupRMregd[rm];;;Bit32u oldrmrd=*rmrd;
   if (rm >= 0xc0 ) {Bit32u * eard=lookupRMEAregd[rm];;*rmrd=*eard;*eard+=oldrmrd;}
...
static int x86p_BSWAP_EAX(void) {
  if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
...
static int x86p_BSWAP_ECX(void) {
  if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
...
static int x86p_BSWAP_EDX(void) {
  if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
...
static int x86p_BSWAP_EBX(void) {
  if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
...
static int x86p_BSWAP_ESP(void) {
  if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
...
static int x86p_BSWAP_EBP(void) {
  if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
...
static int x86p_BSWAP_ESI(void) {
  if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
...
static int x86p_BSWAP_EDI(void) {
  if (CPU_ArchitectureType<0x40) return CASERET_ILLEGAL;
...
int (* const x86p_funptr[1024])(void) = {
x86p_ADD_Eb_Gb, x86p_ADD_Ew_Gw, x86p_ADD_Gb_Eb, x86p_ADD_Gw_Ew, x86p_ADD_AL_Ib,
x86p_ADD_AX_Iw, x86p_WPUSH_ES, x86p_WPOP_ES, x86p_OR_Eb_Gb, x86p_OR_Ew_Gw,
x86p_OR_Gb_Eb, x86p_OR_Gw_Ew, x86p_OR_AL_Ib, x86p_OR_AX_Iw, x86p_WPUSH_CS,
x86p_2_byte_opcodes, x86p_ADC_Eb_Gb, x86p_ADC_Ew_Gw, x86p_ADC_Gb_Eb,
x86p_ADC_Gw_Ew, x86p_ADC_AL_Ib, x86p_ADC_AX_Iw, x86p_WPUSH_SS, x86p_WPOP_SS,
x86p_SBB_Eb_Gb, x86p_SBB_Ew_Gw, x86p_SBB_Gb_Eb, x86p_SBB_Gw_Ew, x86p_SBB_AL_Ib,
x86p_SBB_AX_Iw, x86p_WPUSH_DS, x86p_WPOP_DS, x86p_AND_Eb_Gb, x86p_AND_Ew_Gw,
x86p_AND_Gb_Eb, x86p_AND_Gw_Ew, x86p_AND_AL_Ib, x86p_AND_AX_Iw, x86p_SEG_ES,
x86p_DAA, x86p_SUB_Eb_Gb, x86p_SUB_Ew_Gw, x86p_SUB_Gb_Eb, x86p_SUB_Gw_Ew,
x86p_SUB_AL_Ib, x86p_SUB_AX_Iw, x86p_SEG_CS, x86p_DAS, x86p_XOR_Eb_Gb,
x86p_XOR_Ew_Gw, x86p_XOR_Gb_Eb, x86p_XOR_Gw_Ew, x86p_XOR_AL_Ib, x86p_XOR_AX_Iw,
x86p_SEG_SS, x86p_AAA, x86p_CMP_Eb_Gb, x86p_CMP_Ew_Gw, x86p_CMP_Gb_Eb,
x86p_CMP_Gw_Ew, x86p_CMP_AL_Ib, x86p_CMP_AX_Iw, x86p_SEG_DS, x86p_AAS,
x86p_INC_AX, x86p_INC_CX, x86p_INC_DX, x86p_INC_BX, x86p_INC_SP, x86p_INC_BP,
x86p_INC_SI, x86p_INC_DI, x86p_DEC_AX, x86p_DEC_CX, x86p_DEC_DX, x86p_DEC_BX,
x86p_DEC_SP, x86p_DEC_BP, x86p_DEC_SI, x86p_DEC_DI, x86p_PUSH_AX, x86p_PUSH_CX,
x86p_PUSH_DX, x86p_PUSH_BX, x86p_PUSH_SP, x86p_PUSH_BP, x86p_PUSH_SI,
x86p_PUSH_DI, x86p_POP_AX, x86p_POP_CX, x86p_POP_DX, x86p_POP_BX, x86p_POP_SP,
x86p_POP_BP, x86p_POP_SI, x86p_POP_DI, x86p_PUSHA, x86p_POPA, x86p_BOUND,
x86p_ARPL_Ew_Rw, x86p_SEG_FS, x86p_SEG_GS, x86p_Operand_Size_Prefix,
x86p_Address_Size_Prefix, x86p_PUSH_Iw, x86p_IMUL_Gw_Ew_Iw, x86p_WPUSH_Ib,
x86p_IMUL_Gw_Ew_Ib, x86p_INSB, x86p_INSW, x86p_OUTSB, x86p_OUTSW, x86p_WJO,
x86p_WJNO, x86p_WJB, x86p_WJNB, x86p_WJZ, x86p_WJNZ, x86p_WJBE, x86p_WJNBE,
x86p_WJS, x86p_WJNS, x86p_WJP, x86p_WJNP, x86p_WJL, x86p_WJNL, x86p_WJLE,
x86p_WJNLE, x86p_Grpl_Eb_Ib, x86p_Grpl_Ew_Iw, x86p_Grpl_Eb_Ib, x86p_Grpl_Ew_Ix,
x86p_TEST_Eb_Gb, x86p_TEST_Ew_Gw, x86p_XCHG_Eb_Gb, x86p_XCHG_Ew_Gw,
x86p_MOV_Eb_Gb, x86p_MOV_Ew_Gw, x86p_MOV_Gb_Eb, x86p_MOV_Gw_Ew,
x86p_WMov_Ew_Sw, x86p_LEA_Gw, x86p_MOV_Sw_Ew, x86p_POP_Ew, x86p_NOP,
x86p_XCHG_CX_AX, x86p_XCHG_DX_AX, x86p_XCHG_BX_AX, x86p_XCHG_SP_AX,
x86p_XCHG_BP_AX, x86p_XCHG_SI_AX, x86p_XCHG_DI_AX, x86p_CBW, x86p_CWD,
x86p_CALL_Ap, x86p_NOP, x86p_PUSHF, x86p_POPF, x86p_SAHF, x86p_LAHF,
x86p_MOV_AL_Ob, x86p_MOV_AX_Ow, x86p_MOV_Ob_AL, x86p_MOV_Ow_AX, x86p_MOVSB,
x86p_MOVSW, x86p_CMPSB, x86p_CMPSW, x86p_TEST_AL_Ib, x86p_TEST_AX_Iw,
x86p_STOSB, x86p_STOSW, x86p_LODSB, x86p_LODSW, x86p_SCASB, x86p_SCASW,
x86p_MOV_AL_Ib, x86p_MOV_CL_Ib, x86p_MOV_DL_Ib, x86p_MOV_BL_Ib, x86p_MOV_AH_Ib,
x86p_MOV_CH_Ib, x86p_MOV_DH_Ib, x86p_MOV_BH_Ib, x86p_MOV_AX_Iw, x86p_MOV_CX_Iw,
x86p_MOV_DX_Iw, x86p_MOV_BX_Iw, x86p_MOV_SP_Iw, x86p_MOV_BP_Iw, x86p_MOV_SI_Iw,
x86p_MOV_DI_Iw, x86p_GRP2_Eb_Ib, x86p_GRP2_Ew_Ib, x86p_WRETN_Iw, x86p_WRETN,
x86p_WLES, x86p_WLDS, x86p_MOV_Eb_Ib, x86p_MOV_EW_Iw, x86p_WENTER_Iw_Ib,
x86p_WLEAVE, x86p_WRETF_Iw, x86p_WRETF, x86p_INT3, x86p_INT_Ib, x86p_INTO,
x86p_WIRET, x86p_GRP2_Eb_1, x86p_GRP2_Ew_1, x86p_GRP2_Eb_CL, x86p_GRP2_Ew_CL,
x86p_AAM_Ib, x86p_AAD_Ib, x86p_SALC, x86p_XLAT, x86p_FPU_ESC_0, x86p_FPU_ESC_1,
x86p_FPU_ESC_2, x86p_FPU_ESC_3, x86p_FPU_ESC_4, x86p_FPU_ESC_5, x86p_FPU_ESC_6,
x86p_FPU_ESC_7, x86p_WLOOPNZ, x86p_WLOOPZ, x86p_WLOOP, x86p_WJCXZ,
x86p_IN_AL_Ib, x86p_IN_AX_Ib, x86p_OUT_Ib_AL, x86p_OUT_Ib_AX, x86p_CALL_Jw,
x86p_JMP_Jw, x86p_JMP_Ap, x86p_WJMP_Jb, x86p_IN_AL_DX, x86p_IN_AX_DX,
x86p_OUT_DX_AL, x86p_OUT_DX_AX, x86p_LOCK, x86p_ICEBP, x86p_REPNZ, x86p_REPZ,
x86p_HLT, x86p_CMC, x86p_GRP3_Eb_Ib, x86p_GRP3_Ew_Iw, x86p_CLC, x86p_STC,
x86p_CLI, x86p_STI, x86p_CLD, x86p_STD, x86p_GRP4_Eb, x86p_GRP5_Ew,
x86p_0F_WGRP_6_Exxx, x86p_Group_7_Ew, x86p_LAR_Gw_Ew, x86p_LSL_Gw_Ew,
x86_illegal, x86_illegal, x86p_CLTS, x86_illegal, x86p_INVD, x86p_INVD,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86p_MOV_Rd_CRx,
x86p_MOV_Rd_DRx, x86p_MOV_CRx_Rd, x86p_MOV_DRx_Rd, x86p_MOV_Rd_TRx,
x86_illegal, x86p_MOV_TRx_Rd, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86p_RDTSC, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
...
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86p_0F_WJO, x86p_0F_WJNO, x86p_0F_WJB, x86p_0F_WJNB,
x86p_0F_WJZ, x86p_0F_WJNZ, x86p_0F_WJBE, x86p_0F_WJNBE, x86p_0F_WJS,
x86p_0F_WJNS, x86p_0F_WJP, x86p_0F_WJNP, x86p_0F_WJL, x86p_0F_WJNL,
x86p_0F_WJLE, x86p_0F_WJNLE, x86p_SETO, x86p_SETNO, x86p_SETB, x86p_SETNB,
x86p_SETZ, x86p_SETNZ, x86p_SETBE, x86p_SETNBE, x86p_SETS, x86p_SETNS,
x86p_SETP, x86p_SETNP, x86p_SETL, x86p_SETNL, x86p_SETLE, x86p_SETNLE,
x86p_0F_WPUSH_FS, x86p_0F_WPOP_FS, x86p_CPUID, x86p_BT_Ew_Gw,
x86p_SHLD_Ew_Gw_Ib, x86p_SHLD_Ew_Gw_CL, x86_illegal, x86_illegal,
x86p_0F_WPUSH_GS, x86p_0F_WPOP_GS, x86_illegal, x86p_BTS_Ew_Gw,
x86p_SHRD_Ew_Gw_Ib, x86p_SHRD_Ew_Gw_CL, x86_illegal, x86p_IMUL_Gw_Ew,
x86p_cmpxchg_Eb_Gb, x86p_cmpxchg_Ew_Gw, x86p_LSS_Ew, x86p_BTR_Ew_Gw,
x86p_LFS_Ew, x86p_LGS_Ew, x86p_MOVZX_Gw_Eb, x86p_MOV_Gw_Ew, x86_illegal,
x86_illegal, x86p_GRP8_Ew_Ib, x86p_BTC_Ew_Gw, x86p_BSF_Gw_Ew, x86p_BSR_Gw_Ew,
x86p_MOVSX_Gw_Eb, x86p_MOV_Gw_Ew, x86p_XADD_Gb_Eb, x86p_XADD_Gw_Ew,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86p_BSWAP_AX, x86p_BSWAP_CX, x86p_BSWAP_DX, x86p_BSWAP_BX, x86p_BSWAP_SP,
x86p_BSWAP_BP, x86p_BSWAP_SI, x86p_BSWAP_DI, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
...
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86p_ADD_Eb_Gb,
x86p_ADD_Ed_Gd, x86p_ADD_Gb_Eb, x86p_ADD_Gd_Ed, x86p_ADD_AL_Ib,
x86p_ADD_EAX_Id, x86p_DPUSH_ES, x86p_DPOP_ES, x86p_OR_Eb_Gb, x86p_OR_Ed_Gd,
x86p_OR_Gb_Eb, x86p_OR_Gd_Ed, x86p_OR_AL_Ib, x86p_OR_EAX_Id, x86p_DPUSH_CS,
x86p_2_byte_opcodes, x86p_ADC_Eb_Gb, x86p_ADC_Ed_Gd, x86p_ADC_Gb_Eb,
x86p_ADC_Gd_Ed, x86p_ADC_AL_Ib, x86p_ADC_EAX_Id, x86p_DPUSH_SS, x86p_DPOP_SS,
x86p_SBB_Eb_Gb, x86p_SBB_Ed_Gd, x86p_SBB_Gb_Eb, x86p_SBB_Gd_Ed, x86p_SBB_AL_Ib,
x86p_SBB_EAX_Id, x86p_DPUSH_DS, x86p_DPOP_DS, x86p_AND_Eb_Gb, x86p_AND_Ed_Gd,
x86p_AND_Gb_Eb, x86p_AND_Gd_Ed, x86p_AND_AL_Ib, x86p_AND_EAX_Id, x86p_SEG_ES,
x86p_DAA, x86p_SUB_Eb_Gb, x86p_SUB_Ed_Gd, x86p_SUB_Gb_Eb, x86p_SUB_Gd_Ed,
x86p_SUB_AL_Ib, x86p_SUB_EAX_Id, x86p_SEG_CS, x86p_DAS, x86p_XOR_Eb_Gb,
x86p_XOR_Ed_Gd, x86p_XOR_Gb_Eb, x86p_XOR_Gd_Ed, x86p_XOR_AL_Ib,
x86p_XOR_EAX_Id, x86p_SEG_SS, x86p_AAA, x86p_CMP_Eb_Gb, x86p_CMP_Ed_Gd,
x86p_CMP_Gb_Eb, x86p_CMP_Gd_Ed, x86p_CMP_AL_Ib, x86p_CMP_EAX_Id, x86p_SEG_DS,
x86p_AAS, x86p_INC_EAX, x86p_INC_ECX, x86p_INC_EDX, x86p_INC_EBX, x86p_INC_ESP,
x86p_INC_EBP, x86p_INC_ESI, x86p_INC_EDI, x86p_DEC_EAX, x86p_DEC_ECX,
x86p_DEC_EDX, x86p_DEC_EBX, x86p_DEC_ESP, x86p_DEC_EBP, x86p_DEC_ESI,
x86p_DEC_EDI, x86p_PUSH_EAX, x86p_PUSH_ECX, x86p_PUSH_EDX, x86p_PUSH_EBX,
x86p_PUSH_ESP, x86p_PUSH_EBP, x86p_PUSH_ESI, x86p_PUSH_EDI, x86p_POP_EAX,
x86p_POP_ECX, x86p_POP_EDX, x86p_POP_EBX, x86p_POP_ESP, x86p_POP_EBP,
x86p_POP_ESI, x86p_POP_EDI, x86p_PUSHAD, x86p_POPAD, x86p_BOUND_Ed,
x86p_ARPL_Ed_Rd, x86p_SEG_FS, x86p_SEG_GS, x86p_Operand_Size_Prefix,
x86p_Address_Size_Prefix, x86p_PUSH_Id, x86p_IMUL_Gd_Ed_Id, x86p_DPUSH_Ib,
x86p_IMUL_Gd_Ed_Ib, x86p_INSB, x86p_INSD, x86p_OUTSB, x86p_OUTSD, x86p_DJO,
x86p_DJNO, x86p_DJB, x86p_DJNB, x86p_DJZ, x86p_DJNZ, x86p_DJBE, x86p_DJNBE,
x86p_DJS, x86p_DJNS, x86p_DJP, x86p_DJNP, x86p_DJL, x86p_DJNL, x86p_DJLE,
x86p_DJNLE, x86p_Grpl_Eb_Ib, x86p_Grpl_Ed_Id, x86p_Grpl_Eb_Ib, x86p_Grpl_Ed_Ix,
x86p_TEST_Eb_Gb, x86p_TEST_Ed_Gd, x86p_XCHG_Eb_Gb, x86p_XCHG_Ed_Gd,
x86p_MOV_Eb_Gb, x86p_MOV_Ed_Gd, x86p_MOV_Gb_Eb, x86p_MOV_Gd_Ed,
x86p_DMov_Ew_Sw, x86p_LEA_Gd, x86p_MOV_Sw_Ew, x86p_POP_Ed, x86p_NOP,
x86p_XCHG_ECX_EAX, x86p_XCHG_EDX_EAX, x86p_XCHG_EBX_EAX, x86p_XCHG_ESP_EAX,
x86p_XCHG_EBP_EAX, x86p_XCHG_ESI_EAX, x86p_XCHG_EDI_EAX, x86p_CWDE, x86p_CDQ,
x86p_CALL_FAR_Ad, x86p_NOP, x86p_PUSHFD, x86p_POPFD, x86p_SAHF, x86p_LAHF,
x86p_MOV_AL_Ob, x86p_MOV_EAX_Od, x86p_MOV_Ob_AL, x86p_MOV_Od_EAX, x86p_MOVSB,
x86p_MOVSD, x86p_CMPSB, x86p_CMPSD, x86p_TEST_AL_Ib, x86p_TEST_EAX_Id,
x86p_STOSB, x86p_STOSD, x86p_LODSB, x86p_LODSD, x86p_SCASB, x86p_SCASD,
x86p_MOV_AL_Ib, x86p_MOV_CL_Ib, x86p_MOV_DL_Ib, x86p_MOV_BL_Ib, x86p_MOV_AH_Ib,
x86p_MOV_CH_Ib, x86p_MOV_DH_Ib, x86p_MOV_BH_Ib, x86p_MOV_EAX_Id,
x86p_MOV_ECX_Id, x86p_MOV_EDX_Iw, x86p_MOV_EBX_Id, x86p_MOV_ESP_Id,
x86p_MOV_EBP_Id, x86p_MOV_ESI_Id, x86p_MOV_EDI_Id, x86p_GRP2_Eb_Ib,
x86p_GRP2_Ed_Ib, x86p_DRETN_Iw, x86p_DRETN, x86p_DLES, x86p_DLDS,
x86p_MOV_Eb_Ib, x86p_MOV_Ed_Id, x86p_DENTER_Iw_Ib, x86p_DLEAVE, x86p_DRETF_Iw,
x86p_DRETF, x86p_INT3, x86p_INT_Ib, x86p_INTO, x86p_DIRET, x86p_GRP2_Eb_1,
x86p_GRP2_Ed_1, x86p_GRP2_Eb_CL, x86p_GRP2_Ed_CL, x86p_AAM_Ib, x86p_AAD_Ib,
x86p_SALC, x86p_XLAT, x86p_FPU_ESC_0, x86p_FPU_ESC_1, x86p_FPU_ESC_2,
x86p_FPU_ESC_3, x86p_FPU_ESC_4, x86p_FPU_ESC_5, x86p_FPU_ESC_6, x86p_FPU_ESC_7,
x86p_DLOOPNZ, x86p_DLOOPZ, x86p_DLOOP, x86p_DJCXZ, x86p_IN_AL_Ib,
x86p_IN_EAX_Ib, x86p_OUT_Ib_AL, x86p_OUT_Ib_EAX, x86p_CALL_Jd, x86p_JMP_Jd,
x86p_JMP_Ad, x86p_DJMP_Jb, x86p_IN_AL_DX, x86p_IN_EAX_DX, x86p_OUT_DX_AL,
x86p_OUT_DX_EAX, x86p_LOCK, x86p_ICEBP, x86p_REPNZ, x86p_REPZ, x86p_HLT,
x86p_CMC, x86p_GRP3_Eb_Ib, x86p_GRP3_Ed_Id, x86p_CLC, x86p_STC, x86p_CLI,
x86p_STI, x86p_CLD, x86p_STD, x86p_GRP4_Eb, x86p_GRP_5_Ed, x86p_0F_DGRP_6_Exxx,
x86p_Group_7_Ed, x86p_LAR_Gd_Ed, x86p_LSL_Gd_Ew, x86_illegal, x86_illegal,
x86p_CLTS, x86_illegal, x86p_INVD, x86p_INVD, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86p_MOV_Rd_CRx, x86p_MOV_Rd_DRx, x86p_MOV_CRx_Rd,
x86p_MOV_DRx_Rd, x86p_MOV_Rd_TRx, x86_illegal, x86p_MOV_TRx_Rd, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86p_RDTSC, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
...
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86p_0F_DJO, x86p_0F_DJNO,
x86p_0F_DJB, x86p_0F_DJNB, x86p_0F_DJZ, x86p_0F_DJNZ, x86p_0F_DJBE,
x86p_0F_DJNBE, x86p_0F_DJS, x86p_0F_DJNS, x86p_0F_DJP, x86p_0F_DJNP,
x86p_0F_DJL, x86p_0F_DJNL, x86p_0F_DJLE, x86p_0F_DJNLE, x86p_SETO, x86p_SETNO,
x86p_SETB, x86p_SETNB, x86p_SETZ, x86p_SETNZ, x86p_SETBE, x86p_SETNBE,
x86p_SETS, x86p_SETNS, x86p_SETP, x86p_SETNP, x86p_SETL, x86p_SETNL,
x86p_SETLE, x86p_SETNLE, x86p_0F_DPUSH_FS, x86p_0F_DPOP_FS, x86p_CPUID,
x86p_BT_Ed_Gd, x86p_SHLD_Ed_Gd_Ib, x86p_SHLD_Ed_Gd_CL, x86_illegal,
x86_illegal, x86p_0F_DPUSH_GS, x86p_0F_DPOP_GS, x86_illegal, x86p_BTS_Ed_Gd,
x86p_SHRD_Ed_Gd_Ib, x86p_SHRD_Ed_Gd_CL, x86_illegal, x86p_IMUL_Gd_Ed,
x86p_cmpxchg_Eb_Gb, x86p_CMPXCHG_Ed_Gd, x86p_LSS_Ed, x86p_BTR_Ed_Gd,
x86p_LFS_Ed, x86p_LGS_Ed, x86p_MOVZX_Gd_Eb, x86p_MOVXZ_Gd_Ew, x86_illegal,
x86_illegal, x86p_GRP8_Ed_Ib, x86p_BTC_Ed_Gd, x86p_BSF_Gd_Ed, x86p_BSR_Gd_Ed,
x86p_MOVSX_Gd_Eb, x86p_MOVSX_Gd_Ew, x86p_XADD_Gb_Eb, x86p_XADD_Gd_Ed,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86p_BSWAP_EAX, x86p_BSWAP_ECX, x86p_BSWAP_EDX, x86p_BSWAP_EBX, x86p_BSWAP_ESP,
x86p_BSWAP_EBP, x86p_BSWAP_ESI, x86p_BSWAP_EDI, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal, x86_illegal,
